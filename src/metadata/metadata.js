var loginFormData = {
    ...
    fields: [
        ...
        {elementType:"input", type:"submit", classes:"formSubmit", value:"Login", genre:"simple", style:"display:block;margin-top:1%"}
...
var createEventFormData = {
    ...
    fields: [
        ...
        {elementType:"input", classes:"form-input", value:"", genre:"simple",prop:"name", style:"min-width:500px"},
        ...
        }, genre:"complex", style:"max-width:400px"},
        {elementType:"h3", classes:"form-label", value:"What's Your Agenda :", genre:"simple"},
        {elementType:"input", classes:"form-input", value:"", genre:"simple", prop:"agenda", style:"min-width:500px"},
        {elementType:"h3", classes:"form-label", value:"Venue :", genre:"simple"},
        {elementType:"input", classes:"form-input", value:"", genre:"simple", prop:"venue", style:"min-width:500px"},
        {elementType:"h3", classes:"form-label", value:"Date :", genre:"simple"},
        {elementType:"input", data_type:"custom-date", classes:"form-input", value:"", genre:"simple", prop:"dateOfEvent", style:"max-width:400px"},
        ...
        {elementType:"input", type:"submit", classes:"formSubmit", value:"Create Event", genre:"simple", style:"margin-right:1%"},
        {elementType:"button", type:"cancel", classes:"formCancel", value:"Cancel", genre:"simple", style:"margin-right:1%"}
